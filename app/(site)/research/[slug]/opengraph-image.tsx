  ...
  return new ImageResponse(
    (
      <div style={{
        ...
        <div style={{ display: 'flex', fontSize: 64, lineHeight: 1.15 }}>{p?.title ?? 'Blink Research'}</div>
        <div style={{ display: 'flex', fontSize: 24, opacity: 0.7 }}>blinkgroup.com.br/research</div>
      </div>
    ),
    size,
  );
